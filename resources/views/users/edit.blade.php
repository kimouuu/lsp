...
@error('password') is-invalid @enderror" id="exampleInputPassword" placeholder="Password" name="password">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('level') is-invalid @enderror" id="exampleInputlevel" name="level">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('aktif') is-invalid @enderror" id="exampleInputAktif" name="aktif">
