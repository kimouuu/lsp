...
<section class="logos" style="margin-top: 9rem; padding-bottom: 3rem">
    <div class="logos__container container grid">
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/gg.png') }}" alt="" />
        </div>
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/airbnb.png') }}" alt="" />
        </div>
        <div class="logos__img">
            <img src="{{ asset('frontend/assets/img/wi.png') }}" alt="" />
        </div>
        <div class="logos__img">
        ...
        <div class="popular__container swiper">
            <div class="swiper-wrapper">
                ...
                <article class="popular__card swiper-slide">
                    <a href=" {{ route('blog.show',$paket->id) }}">
                        <img src="storage/{{$paket->foto1}}" alt="" class="popular__img" />
                        <div class="popular__data">
                            <h2 class="popular__price">
                                <span>Rp. </span>{{ number_format($paket->harga_paket) }}
                            </h2>
...
<section class="blog section" id="blog">
    <div class="blog__container container">
        ...
        <h2 class="section__title" style="text-align: center">
            The Recomended Trip For You
        </h2>

        <div class="blog__content grid">
            <img src="{{ asset('frontend/assets/img/bali.png') }}" alt="" />
