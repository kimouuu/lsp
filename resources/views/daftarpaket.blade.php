    ...
    <div class="swiper-container gallery-top">
        <div class="swiper-wrapper">
            <section class="islands swiper-slide">
                ...
                <img src="/storage/{{$blog->foto3}}" alt="ga tampil" class="islands__bg" />

                <div class="islands__container container">
                    <div class="islands__data">
                        <h2 class="islands__subtitle">{{ $blog->nama_paket}}</h2>
        ...
        <div class="content__container">
            <div class="blog__detail">
                ...
                <div class="blog__detail">
                    ...
                    <h2 class="popular__price"><span>$</span>{{ number_format($blog->harga_paket,2) }}</h2>
              ...
              @foreach($daftarpaket as $daftarpaket)
                ...
                <div class="popular__data">
                    <h2 class="popular__price"><span>$</span>{{ number_format($daftarpaket->price,2) }}</h2>
